...
namespace Volt
{
	...
	private:
		...
		VTR_API static void OnCreate(LightEntity entity);
		VTR_API static void OnDestroy(LightEntity entity);
		VTR_API static void OnTransformChanged(LightEntity entity);
		VTR_API static void OnComponentCopied(LightEntity entity);
		VTR_API static void OnMemberChanged(LightEntity entity);
