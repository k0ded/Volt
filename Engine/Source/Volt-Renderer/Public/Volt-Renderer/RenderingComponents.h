...
namespace Volt
{
	...
	struct MeshComponent
	{
		...
		VTR_API static void OnMemberChanged(MeshEntity entity);

	private:
		VTR_API static void OnCreate(MeshEntity entity);
		VTR_API static void OnDestroy(MeshEntity entity);
		VTR_API static void OnTransformChanged(MeshEntity entity);
		VTR_API static void OnComponentCopied(MeshEntity entity);
	...
	private:
		...
		VTR_API static void OnCreate(CameraEntity entity);
	};
	...
	private:
		...
		VTR_API static void OnStart(WeaveEntity entity);
	};
