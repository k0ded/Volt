...
namespace Volt
{
	...
	public:
		...
		IntRef<RHI::BufferView> GetOrCreateView(const RHI::BufferViewDesc& desc);

	private:
		struct ViewPair
		{
			size_t hash;
			IntRef<RHI::BufferView> view;
		};
	...
	public:
		...
		IntRef<RHI::ImageView> GetOrCreateView(const RHI::ImageViewDesc& desc);
