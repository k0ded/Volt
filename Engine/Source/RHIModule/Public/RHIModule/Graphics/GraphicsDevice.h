...
namespace Volt::RHI
{
	...
	public:
		...
		virtual IntRef<DeviceQueue> GetDeviceQueue(QueueType queueType) const = 0;
		...
		static IntRef<GraphicsDevice> Create(const GraphicsDeviceCreateInfo& deviceInfo, RawPtr<PhysicalGraphicsDevice> physicalGraphicsDevice, bool enableDebugLayer);
