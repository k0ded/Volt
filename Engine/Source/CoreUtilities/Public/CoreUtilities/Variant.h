...
private:
	...
	using StorageType = std::aligned_storage_t<MaxSize, MaxAlignment>;

	VT_INLINE void Destroy();

	VT_INLINE void CopyInto(StorageType& dstStorage, size_t& dstIndex) const;
	template<size_t I> void CopyRecursive(StorageType& dstStorage, size_t& dstIndex) const;

	VT_INLINE void MoveInto(StorageType& dstStorage, size_t& dstIndex) const;
	template<size_t I> void MoveRecursive(StorageType& dstStorage, size_t& dstIndex) const;

	VT_INLINE static void DestroyAtIndex(size_t index, StorageType& storage);
	template<size_t I> static void DestroyRecursive(size_t index, StorageType& storage);
...
template<typename...Ts>
VT_INLINE void Variant<Ts...>::DestroyAtIndex(size_t index, StorageType& storage)
{
...
template<typename... Ts>
template<size_t I>
VT_INLINE void Variant<Ts...>::DestroyRecursive(size_t index, StorageType& storage)
{
...
template<typename...Ts>
VT_INLINE void Variant<Ts...>::CopyInto(StorageType& dstStorage, size_t& dstIndex) const
{
...
template<typename...Ts>
template<size_t I>
void Variant<Ts...>::CopyRecursive(StorageType& dstStorage, size_t& dstIndex) const
{
	if constexpr (I < sizeof...(Ts))
	{
		if (m_typeIndex == I)
...
template<typename...Ts>
VT_INLINE void Variant<Ts...>::MoveInto(StorageType& dstStorage, size_t& dstIndex) const
{
...
template<typename...Ts>
template<size_t I>
void Variant<Ts...>::MoveRecursive(StorageType& dstStorage, size_t& dstIndex) const
{
	if constexpr (I < sizeof...(Ts))
	{
		if (m_typeIndex == I)
