...
#include "CoreUtilities/Delegates/MulticastDelegate.h"
...
#define FUNC_DECLARE_MULTICAST_DELEGATE(DelegateName, ReturnType, ...) \
	using DelegateName = Volt::MulticastDelegate<ReturnType(__VA_ARGS__)>
