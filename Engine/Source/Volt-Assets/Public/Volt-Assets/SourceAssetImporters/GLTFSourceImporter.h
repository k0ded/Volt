...
namespace Volt
{
	...
	private:
		...
		Vector<AssetReference<Asset_New>> ImportAsStaticMesh(tinygltf::Model& gltfModel, const MeshSourceImportConfig importConfig, const SourceAssetUserImportData& userData) const;
	};
}
