...
#ifdef IMGUINODEEDITOR_DLL_EXPORT
#define IMGUINODEEDITOR_API __declspec(dllexport)
#else
#define IMGUINODEEDITOR_API __declspec(dllimport)
#endif
...
namespace ImGui
{
	...
	IMGUINODEEDITOR_API void          BeginHorizontal(const char* str_id, const ImVec2& size = ImVec2(0, 0), float align = -1.0f);
	IMGUINODEEDITOR_API void          BeginHorizontal(const void* ptr_id, const ImVec2& size = ImVec2(0, 0), float align = -1.0f);
	IMGUINODEEDITOR_API void          BeginHorizontal(int id, const ImVec2& size = ImVec2(0, 0), float align = -1);
	IMGUINODEEDITOR_API void          EndHorizontal();
	IMGUINODEEDITOR_API void          BeginVertical(const char* str_id, const ImVec2& size = ImVec2(0, 0), float align = -1.0f);
	IMGUINODEEDITOR_API void          BeginVertical(const void* ptr_id, const ImVec2& size = ImVec2(0, 0), float align = -1.0f);
	IMGUINODEEDITOR_API void          BeginVertical(int id, const ImVec2& size = ImVec2(0, 0), float align = -1);
	IMGUINODEEDITOR_API void          EndVertical();
	IMGUINODEEDITOR_API void          Spring(float weight = 1.0f, float spacing = -1.0f);
	IMGUINODEEDITOR_API void          SuspendLayout();
	IMGUINODEEDITOR_API void          ResumeLayout();
