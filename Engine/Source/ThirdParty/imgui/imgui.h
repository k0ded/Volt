...
namespace ImGui
{
	...
	IMGUI_API bool          TreeNodeEx(ImGuiID id, const char* label, ImGuiTreeNodeFlags flags = 0);
	...
	IMGUI_API bool          BeginPopupModal(const char* name, ImGuiID id, bool* p_open = NULL, ImGuiWindowFlags flags = 0); // return true if the modal is open, and you can start outputting to it.
...
enum ImGuiWindowFlags_
{
	...
	// [Volt]
	ImGuiWindowFlags_NoTabBar = 1 << 30
};
...
enum ImGuiTreeNodeFlags_
{
	...
	ImGuiTreeNodeFlags_SpanAllColumns = 1 << 15,
